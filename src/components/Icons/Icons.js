...
export const HomeFullFillIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
  const classes = cx({ [className]: className });
  return (
    <svg
      className={classes}
...
export const UsersIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
  const classes = cx({ [className]: className });
  return (
    <svg
      className={classes}
...
export const UsersFullFillIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
  const classes = cx({ [className]: className });
  return (
    <svg
      className={classes}
...
export const LiveFullFillIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => {
  const classes = cx({ [className]: className });
  return (
    <svg
      className={classes}
